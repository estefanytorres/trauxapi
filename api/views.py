        ...
        if serializer.is_valid():
            if serializer.validated_data['type'] == 'D':
                ...
                send_email(
                    ...
                    '\n\n \n\n'
                    'El primer paso es descargar el sistema utilizando el siguiente link: \n\n \n\n %s \n\n \n\n'
                    'Luego sigue las instrucciones que tenemos para ti en nuestro canal de <a href="%s">youtube</a>'
                    ...
                    '<p><a href="%s">DESCARGA AQUÍ</a></p>'
                    '<p>Luego sigue las instrucciones que tenemos para ti en nuestro canal de '
                    '<a href="%s">youtube</a></p>'
